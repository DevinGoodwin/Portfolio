...
public class LinkedTree {
    ...
    public int numEvenKeys(){
        return numEvenKeysRec(this.root);
    } 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(1) Testing on tree from Problem 7");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {44, 35, 53, 23, 48, 62, 28, 57, 80};
            tree.insertKeys(keys);
        ...
        System.out.println("(2) Testing on tree method numEvenKeys");
        try {
            LinkedTree tree = new LinkedTree();
        ...
        System.out.println("(3) Testing on tree method numEvenKeys");
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {44, 35, 53, 23, 48, 62, 28, 57, 80};
            tree.insertKeys(keys);
        ...
        System.out.println("(4) Testing on tree method deleteMax");
        try {
        ...
        System.out.println("(5) Testing on tree method deleteMax");
        try {
        ...
        System.out.println("(6) Testing on tree method deleteMax");
        try {
